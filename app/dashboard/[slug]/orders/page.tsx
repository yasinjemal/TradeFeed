...
import { OrderNotificationSound } from "@/components/dashboard/order-notification-sound";
      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-stone-500 mt-1">
            ...
            <a
              href={`https://wa.me/?text=${encodeURIComponent(`🛍️ New stock just dropped! Browse & order here:\n\nhttps://tradefeed.co.za/catalog/${slug}`)}`}
              target="_blank"
            ...
            >
              ...
              Notify buyers on WhatsApp
            </a>
          </p>
        </div>
        <OrderNotificationSound shopId={access.shopId} initialOrderCount={stats.total ?? 0} />
      </div>
