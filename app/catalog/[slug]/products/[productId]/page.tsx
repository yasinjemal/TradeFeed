...
// - Variant selector: size → color → shows price + stock
// - WhatsApp order button (pre-filled message with product info)
// - Back to catalog link
//
// PHASE 2D PREP: This page will gain a proper "Add to Cart" button.
// For now, the WhatsApp button sends a single-product enquiry.
// ============================================================
