...
export default async function CatalogLayout({
  ...
  return (
    <CartProvider shopSlug={slug} shopId={shop.id} whatsappNumber={shop.whatsappNumber} retailWhatsappNumber={shop.retailWhatsappNumber ?? undefined} shopProvince={shop.province ?? undefined} shopCity={shop.city ?? undefined} codEnabled={shop.codEnabled} shopName={shop.name} shopLogoUrl={shop.logoUrl ?? undefined} shopVerified={shop.isVerified}>
    <WhatsAppCTAProvider>
