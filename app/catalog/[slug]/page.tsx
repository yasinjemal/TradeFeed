...
export default async function CatalogPage({ params }: CatalogPageProps) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* ── Context-Aware CTAs ─────────────────────────── */}
      {/* Shop owner → management shortcuts */}
      {/* Existing seller → nothing (they know the platform) */}
      {/* New/anonymous visitor → recruitment CTAs */}

      {isOwner && ownerDashboardSlug && (
        <div className="rounded-2xl bg-gradient-to-br from-stone-50 to-stone-100/80 ring-1 ring-stone-200/60 p-5 space-y-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-stone-800">Your Shop</p>
              <p className="text-xs text-stone-500">This is how your customers see you</p>
            </div>
          </div>
          <div className="flex gap-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-semibold text-stone-600 ring-1 ring-stone-200 transition-all hover:bg-stone-50 active:scale-[0.98]"
            >
