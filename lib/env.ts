...
const envSchema = z.object({
  ...
  EMAIL_MARKETING_HMAC_SECRET: z.string().min(32).optional(),
  EMAIL_MARKETING_PROVIDER_READY: z.literal("true").optional(),
  EMAIL_MARKETING_NCC_CLEANSED_AT: z.string().optional(),
  EMAIL_MARKETING_SEND_ENABLED: z.literal("true").optional(),
