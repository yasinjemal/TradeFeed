// ============================================================
// Component — Sticky WhatsApp Order CTA
// ============================================================
// Floating green "Order via WhatsApp" pill shown on all catalog
// pages. Positioned above the bottom nav on the right side.
// Context-aware: shows product name when on a product page.
// ============================================================
...
export function StickyWhatsAppCTA({
  ...
  const message = productName
    ? encodeURIComponent(
        `Hi ${shopName}! I'm interested in *${productName}* from your TradeFeed shop. Is it available? 🛍️`
      )
    : encodeURIComponent(
        `Hi ${shopName}! I'm browsing your TradeFeed shop and I'd like to order. 🛍️`
      );
  ...
  return (
    ...
    >
      ...
      <span className="hidden sm:inline">{productName ? `Ask about this` : "Order via WhatsApp"}</span>
