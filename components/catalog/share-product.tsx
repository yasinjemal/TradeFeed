...
export function ShareProduct({
  ...
  return (
    <div className="space-y-3">
      {/* ── Primary: Share on WhatsApp — BIG & prominent ── */}
      <a
        href={waShareUrl}
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-[#25D366] hover:bg-[#20bd5a] text-white text-sm font-bold transition-all shadow-lg shadow-green-200/60 hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0"
      ...
      {/* ── Secondary row: Facebook + Copy Link ── */}
      <div className="flex items-center gap-2">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-blue-50 border border-blue-200 text-blue-700 text-xs font-medium hover:bg-blue-100 transition-colors"
