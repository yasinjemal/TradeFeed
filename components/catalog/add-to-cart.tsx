            ...
            <div className="mx-auto flex w-full max-w-xl gap-2">
              {quickOrderHref && (
                <a
                  ...
                  className="inline-flex min-h-[48px] items-center justify-center gap-1.5 rounded-xl bg-[#25D366] px-4 text-sm font-bold text-white shadow-sm transition-all hover:opacity-90"
                >
