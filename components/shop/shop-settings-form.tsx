...
export function ShopSettingsForm({
  ...
  // ── Controlled text fields (prevents paste/refresh bug on mobile) ──
                  ...
                  {bannerUploading ? (
                    ...
                    <>
                      ...
                      <div className="text-center">
                        ...
                        <span className="text-[10px] text-slate-400">JPG, PNG or WebP • Max 4MB • Recommended 1200×400</span>
                      </div>
                    </>
                  )}
                </button>
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-2 sm:col-span-2">
            <Label htmlFor="whatsappGroupLink" className="flex items-center gap-2 text-sm font-medium">
              <span className="w-6 h-6 rounded-lg bg-[var(--color-whatsapp)] flex items-center justify-center">
                <svg className="w-3.5 h-3.5 text-white" viewBox="0 0 24 24" fill="currentColor">
