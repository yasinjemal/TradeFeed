...
export function CustomDomainBanner({ shopSlug, planSlug, hasCustomDomain }: CustomDomainBannerProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-blue-200 bg-gradient-to-r from-blue-50 via-white to-indigo-50 p-5 sm:p-6 shadow-sm">
      <div className="absolute top-0 right-0 w-40 h-40 bg-blue-100/40 rounded-full blur-3xl -transtone-y-10 transtone-x-10" />
      ...
      <div className="relative flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <Link
          ...
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-blue-600 text-white text-sm font-semibold shadow-lg shadow-blue-600/20 hover:bg-blue-500 hover:-transtone-y-0.5 active:transtone-y-0 transition-all flex-shrink-0"
        >
          Upgrade to Pro
