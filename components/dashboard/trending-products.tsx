...
function TrendingRow({
  ...
  return (
    ...
    >
      {/* Rank */}
      <div className="w-8 h-8 rounded-lg bg-slate-50 flex items-center justify-center flex-shrink-0 text-sm font-bold text-slate-400 group-hover:bg-slate-100 transition-colors">
        {medal ?? rank}
      </div>
